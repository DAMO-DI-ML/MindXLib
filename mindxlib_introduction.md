...
```
准确率: 0.83
IF A10 AND A9, THEN 1
ELIF A13==g AND A11<=0.0 AND A9, THEN 1
ELIF A13==p AND A3<=1.03, THEN 1
ELIF A13==p AND A12, THEN 1
ELSE 0
```
...
![before](./docs/pics/before.png)
![after](./docs/pics/after.png)
在上述约束下:
...
![SHAP散点图示例](docs/pics/scatter.png)
![SHAP瀑布图示例](docs/pics/adult_waterfall.png)
