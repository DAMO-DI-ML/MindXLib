...
from mindxlib.base import PostHocBlackBoxBase


class LimeTextExplainer(PostHocBlackBoxBase):
    """
...
class LimeImageExplainer(PostHocBlackBoxBase):
    """
...
class LimeTabularExplainer(PostHocBlackBoxBase):
    """
    ...
    def set_parameters(self, verbose=0):
        """
        Optionally, set parameters for the explainer.
        """
        pass
